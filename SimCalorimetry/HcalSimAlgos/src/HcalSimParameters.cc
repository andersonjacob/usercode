...
: CaloSimParameters(simHitToPhotoelectrons, photoelectronsToAnalog, samplingFactor, timePhase,
  ...
  thePixels(0), theExtraNoise(0), theExtraNoiseWidth(0)
{
}
   ...
   thePixels(0), theExtraNoise(0), theExtraNoiseWidth(0)
{
  ...
  if (p.exists("extraNoise")) {
    theExtraNoise = p.getParameter<double>("extraNoise");
    theExtraNoiseWidth = 
      sqrt(theExtraNoise*CaloSimParameters::photoelectronsToAnalog());
    if (p.exists("extraNoiseWidth")) {
      theExtraNoiseWidth = p.getParameter<double>("extraNoiseWidth");
    }
  }
}
