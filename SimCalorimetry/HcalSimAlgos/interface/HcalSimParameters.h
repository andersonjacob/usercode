...
public:
  ...
  // extra noise added in the amplifier in fC.  The noise is Gaussian given by
  // the width.
  double extraNoise() const { return theExtraNoise; }
  double extraNoiseWidth() const { return theExtraNoiseWidth; }
...
private:
  ...
  int thePixels;
  double theExtraNoise;
  double theExtraNoiseWidth;
};
